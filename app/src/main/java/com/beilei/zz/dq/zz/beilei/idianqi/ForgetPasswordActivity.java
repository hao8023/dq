...
//            String result = bean.result;
                    ...
                    Toast.makeText(ForgetPasswordActivity.this, "sucess", Toast.LENGTH_SHORT).show();
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_next:
                ...
                if (TextUtils.isEmpty(msg) || msg.length() == 0) {
                    ...
                    Intent intent = new Intent(ForgetPasswordActivity.this, ForgetPasswordsetPwd.class);
