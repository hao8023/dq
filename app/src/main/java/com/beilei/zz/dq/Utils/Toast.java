package com.beilei.zz.dq.Utils;
...
public class Toast {
    ...
    public static void showMessage(final Context act, final String msg) {
        showMessage(act, msg, android.widget.Toast.LENGTH_SHORT);
    }
    ...
    public static void showMessageLong(final Context act, final String msg) {
        showMessage(act, msg, android.widget.Toast.LENGTH_LONG);
    }
                    ...
                    public void run() {
                        synchronized (synObj) {
                            if (toast != null) {
                                ...
                                toast = android.widget.Toast.makeText(act, msg, len);
                            }
                            toast.show();
                        }
                    }
